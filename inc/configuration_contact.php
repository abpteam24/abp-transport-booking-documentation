<?php
	...
	<div class="tab_item" data-tabs="#abptb_contact">
        <h2 class="abp_color_theme_xs">☎️ Transport Booking - Contact Information Configuration </h2>
        ...
        <div class="_mar_tb" data-image-href="<?php echo esc_url( ABPTB_DOC_URL . '/' ) ?>image/contact_info.png"><img class="_img_control" src="#" alt="Contact Information "></div>
	</div>
<?php
