<?php
    ...
    <div class="tab_item" data-tabs="#abptb_properties">
        ...
        <h6 class="abp_gap_xs">📋 Key Features of Property Management</h6>
        ...
        <h6 class="abp_gap_xs">🔎 Advanced Filtering & Management</h6>
        <ul class="abp_list_margin_xs">
            <li>
        ...
        <h6 class="abp_gap_xs">🧭 Post-wise Property Mapping</h6>
        <ul class="abp_list_margin_xs">
            <li>
        ...
        <h6 class="abp_gap_xs">📄 Pagination & Performance</h6>
        <ul class="abp_list_margin_xs">
            <li>
        ...
        <div class="abp_image" data-image-href="<?php echo esc_url( ABPTB_DOC_URL . '/' ) ?>image/property_list.png">
